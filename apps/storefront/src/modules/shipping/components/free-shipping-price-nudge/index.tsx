    ...
    <div className="rounded-base border border-ui-border-base overflow-hidden">
      ...
      <div className="space-y-2 bg-ui-button-transparent-hover px-4 py-3">
        ...
        <div className="flex justify-between gap-1">
          <div
            className={clx(
              "h-1 max-w-full bg-ui-fg-interactive duration-500 ease-in-out",
              {
          ...
          ></div>
          <div className="h-1 w-fit flex-grow bg-ui-bg-base"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="bg-neutral-900 shadow-none outline-none border-none text-[15px] p-2"
      ...
      <div className="w-[400px] bg-black text-white p-6">
        <div className="pb-4">
          <div className="space-y-3">
            ...
            <div className="flex justify-between gap-1">
              <div
                className={clx(
                  "bg-gradient-to-r from-zinc-400 to-zinc-500 h-1.5 max-w-full duration-500 ease-in-out",
                  {
                ...
                style={{ width: `${price.remaining_percentage}%` }}
              ></div>
              <div className="bg-zinc-600 h-1.5 w-fit flex-grow"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="bg-transparent shadow-none outline-none border-[1px] border-white text-[15px] py-2.5 px-4"
            href="/cart"
          >
            View cart
          </LocalizedClientLink>
          ...
          <LocalizedClientLink
            className="flex-grow bg-white text-neutral-950 shadow-none outline-none border-[1px] border-white text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedClientLink>
